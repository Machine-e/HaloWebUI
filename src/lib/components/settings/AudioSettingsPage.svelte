...
<div class="h-full space-y-6 overflow-y-auto scrollbar-hidden">
	<div class="max-w-6xl mx-auto space-y-6">
				...
				<div class="flex flex-col gap-4">
					...
					{#if isAdmin}
						...
						>
							<button
								type="button"
								class={`flex min-w-0 items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-all ${selectedTab === 'personal' ? 'bg-white text-gray-900 shadow-[0_1px_3px_rgba(15,23,42,0.08)] dark:bg-gray-800 dark:text-white' : 'text-gray-500 hover:bg-white/50 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-800/50 dark:hover:text-gray-200'}`}
								on:click={() => {
							...
							<button
								type="button"
								class={`flex min-w-0 items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-all ${selectedTab === 'global' ? 'bg-white text-gray-900 shadow-[0_1px_3px_rgba(15,23,42,0.08)] dark:bg-gray-800 dark:text-white' : 'text-gray-500 hover:bg-white/50 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-800/50 dark:hover:text-gray-200'}`}
								on:click={() => {
									selectedTab = 'global';
								}}
							>
		...
		{#if selectedTab === 'personal'}
			<section
				class="p-5 space-y-3 transition-all duration-300 {personalDirty
		...
		{:else if selectedTab === 'global' && isAdmin}
			<section
				class="p-5 space-y-3 transition-all duration-300 {globalDirty
					? 'glass-section glass-section-dirty'
					: 'glass-section'}"
			>
