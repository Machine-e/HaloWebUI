<script lang="ts">
	...
	const ensureOAuthDefaults = () => {
		...
		adminConfig.OAUTH_MERGE_ACCOUNTS_BY_EMAIL = adminConfig.OAUTH_MERGE_ACCOUNTS_BY_EMAIL ?? false;
					...
					<section class="glass-section p-5 space-y-4">
						...
						<div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
							...
							<div class="flex items-center gap-3 min-w-0 flex-wrap">
								<div class="glass-icon-badge bg-gray-100 dark:bg-gray-800/50">
									<svg
										width="18"
										height="18"
										viewBox="0 0 120 120"
						...
						<div class="glass-item px-4 py-3 flex items-center gap-2">
							<button
									...
									<div class="flex items-center justify-between gap-4 px-4 py-3">
										<div class="flex min-w-0 items-start gap-3">
											...
											<div class="min-w-0">
												...
												<div
													class="mt-1 max-w-2xl text-xs leading-5 text-gray-500 dark:text-gray-400"
												>
													{$i18n.t(
											...
											<div class="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
												...
												>
													<div>
														...
														<div class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
															{$i18n.t(
																'Only enable this when the login service verifies email addresses.'
															)}
														</div>
													</div>
							...
							<div class="space-y-3">
								...
								<div class="glass-item p-4">
									...
									{#if adminConfig.JWT_EXPIRES_IN === '-1'}
										<div class="mt-3 p-3 glass-warning">
